...
class DataLoader:
    ...
    def load_simulation_data(self) -> Tuple[List[Dict], List[Dict]]:
        """Load vectors and scalars from simulation files"""
...
class LoRaMetricsExtractor:
    ...
    def process(self) -> Dict[str, Any]:
        ...
        # Load data
        vectors, scalars = self.data_loader.load_simulation_data()
